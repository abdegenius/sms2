var CarbonComponents = (function (exports) {
  ...
  var Checkbox = /*#__PURE__*/ (function (_mixin) {
    ...
    function Checkbox(element, options) {
      ...
      _this.manage(
        on(_this.element, 'click', function (event) {
          _this._handleClick(event)
        }),
      )

      _this.manage(
        on(_this.element, 'focus', function (event) {
          _this._handleFocus(event)
        }),
      )

      _this.manage(
        on(_this.element, 'blur', function (event) {
                ...
                _toConsumableArray(changeStateArgs).concat([
                  function () {
                    fireOnNode.dispatchEvent(
                      new CustomEvent(
                        _this.options['eventAfter'.concat(eventNameSuffix)],
                        {
                          bubbles: true,
                          cancelable: true,
                          detail: detail,
  ...
  var FileUploader = /*#__PURE__*/ (function (_mixin) {
    ...
    function FileUploader(element) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_changeState', function (
        state,
        detail,
        callback,
      ) {
        ...
        function (evt) {
          ...
          if (
            Array.prototype.indexOf.call(evt.dataTransfer.types, 'Files') >=
              0 &&
            !eventMatches(evt, _this.options.selectorOtherDropContainers)
          ) {
            var inArea =
              isOfSelf && eventMatches(evt, _this.options.selectorDropContainer)
      ...
      _this.manage(
        on(_this.input, 'change', function () {
      ...
      _this.manage(
        on(_this.element.ownerDocument, 'dragleave', _this._handleDragDrop),
      )
      ...
      [
        {
          ...
          value: function _filenamesHTML(name, id) {
            return '<span class="'
              .concat(this.options.classSelectedFile, '">\n      <p class="')
  ...
  var Tab = /*#__PURE__*/ (function (_ContentSwitcher) {
    ...
    function Tab(element, options) {
      ...
      _this.manage(
        on(_this.element, 'keydown', function (event) {
          _this._handleKeyDown(event)
        }),
      )

      _this.manage(
        on(_this.element.ownerDocument, 'click', function (event) {
      ...
      [
        {
          ...
          value: function _changeState(detail, callback) {
            ...
            _get(_getPrototypeOf(Tab.prototype), '_changeState', this).call(
              this,
              detail,
              function (error) {
                if (!error) {
        ...
        },
        {
          ...
          value: function _handleClick(event) {
            ...
            if (
              ...
              _get(_getPrototypeOf(Tab.prototype), '_handleClick', this).call(
                this,
                event,
              )
  ...
  var FloatingMenu = /*#__PURE__*/ (function (_mixin) {
    ...
    function FloatingMenu(element, options) {
      ...
      _this.manage(
        on(_this.element.ownerDocument, 'keydown', function (event) {
          _this._handleKeydown(event)
        }),
      )
    ...
    _createClass(FloatingMenu, [
      ...
      },
      {
        ...
        value: function _testStyles() {
          ...
          var element = this.element
          var computedStyle = element.ownerDocument.defaultView.getComputedStyle(
            element,
          )
          var styles = {
            position: 'absolute',
      ...
      },
      {
        ...
        value: function _changeState(state, detail, callback) {
          ...
          if (state === 'shown') {
            ...
            if (
              !this.element.hasAttribute(this.options.attribAvoidFocusOnOpen)
            ) {
              ...
              var focusableNode = contentNode.matches(
                settings_1.selectorFocusable,
              )
                ? contentNode
                : contentNode.querySelector(settings_1.selectorFocusable)
      ...
      },
      {
        ...
        value: function release() {
          ...
          _get(_getPrototypeOf(FloatingMenu.prototype), 'release', this).call(
            this,
          )
        },
      },
  ...
  var triggerButtonPositionProps = /* #__PURE__ */ (function () {
    ...
    return (
      (_ref = {}),
      _defineProperty(_ref, DIRECTION_TOP, 'bottom'),
      _defineProperty(_ref, DIRECTION_BOTTOM, 'top'),
      _defineProperty(_ref, DIRECTION_LEFT, 'left'),
      _defineProperty(_ref, DIRECTION_RIGHT, 'right'),
      _ref
    )
  })()
  /**
  ...
  var triggerButtonPositionFactors = /* #__PURE__ */ (function () {
    ...
    return (
      (_ref2 = {}),
      _defineProperty(_ref2, DIRECTION_TOP, -2),
      _defineProperty(_ref2, DIRECTION_BOTTOM, -1),
      _defineProperty(_ref2, DIRECTION_LEFT, -2),
      _defineProperty(_ref2, DIRECTION_RIGHT, -1),
      _ref2
    )
  })()
  /**
  ...
  var OverflowMenu = /*#__PURE__*/ (function (_mixin) {
    ...
    function OverflowMenu(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'navigate', function (
        direction,
      ) {
        ...
        for (
          ...
          if (
            ...
            !current.parentNode.matches(_this.options.selectorItemHidden) &&
      ...
      _this.manage(
        on(_this.element, 'mousedown', function () {
      ...
      _createClass(InitComponentByLauncher, null, [
        {
          ...
          value: function init() {
            ...
            if (
              ...
              var handles = effectiveOptions.initEventNames.map(function (
                name,
              ) {
                return on(target, name, function (event) {
                  var launcher = eventMatches(
                    event,
                    '['.concat(effectiveOptions.attribInitTarget, ']'),
                  )

                  if (launcher) {
                    event.delegateTarget = launcher // eslint-disable-line no-param-reassign

                    var elements = launcher.ownerDocument.querySelectorAll(
  ...
  var Modal = /*#__PURE__*/ (function (_mixin) {
    ...
    function Modal(element, options) {
      ...
      _defineProperty(
        ...
        function (evt) {
          var focusWrapNode =
            _this.element.querySelector(_this.options.selectorModalContainer) ||
            _this.element
      ...
      [
            ...
            var transitionEnd = function transitionEnd() {
              ...
              if (
                ...
                var focusableItem =
                  ...
                  ) || _this2.element.querySelector(settings_1.selectorTabbable)
        ...
        },
        {
          ...
          value: function _hookCloseActions() {
            ...
            this.manage(
              on(this.element, 'click', function (evt) {
                var closeButton = eventMatches(
                  evt,
                  _this3.options.selectorModalClose,
                )
            ...
            this._handleKeydownListener = this.manage(
              on(this.element.ownerDocument.body, 'keydown', function (evt) {
      ...
      [
        ...
        },
        {
          ...
          value: function end() {
            ...
            var handleAnimationEnd = this.manage(
              on(this.element, 'animationend', function (evt) {
        ...
        },
        {
          ...
          value: function _deleteElement() {
            ...
            if (
              parentNode.classList.contains(this.options.selectorLoadingOverlay)
            ) {
              parentNode.remove()
            }
          },
  ...
  var Dropdown = /*#__PURE__*/ (function (_mixin) {
    ...
    function Dropdown(element, options) {
      ...
      if (
        ...
        _this.manage(
          on(_this.element, 'mouseover', function (event) {
            var item = eventMatches(event, _this.options.selectorItem)
            ...
            if (
              ...
              if (!triggerNode) {
                listItems.forEach(function (item) {
                  if (
                    _this2.element.classList.contains(_this2.options.classOpen)
                  ) {
                    item.tabIndex = 0
                  } else {
                    item.tabIndex = -1
  ...
  var NumberInput = /*#__PURE__*/ (function (_mixin) {
    ...
    function NumberInput(element, options) {
      ...
      _this.manage(
        on(_this.element.querySelector('.up-icon'), 'click', function (event) {
          _this._handleClick(event)
        }),
      )

      _this.manage(
        on(_this.element.querySelector('.down-icon'), 'click', function (
          event,
        ) {
          _this._handleClick(event)
        }),
  ...
  var DataTable = /*#__PURE__*/ (function (_mixin) {
    ...
    function DataTable(_element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_sortToggle', function (
        detail,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_selectToggle', function (
        detail,
      ) {
        var element = detail.element
      ...
      _defineProperty(
        ...
        function () {
          ...
          var row = toArray$4(
            _this.element.querySelectorAll(_this.options.selectorTableSelected),
          )
        ...
        function (toggleOn) {
          ...
          if (_this.batchActionEl) {
            handleTransitionEnd = _this.manage(
              on(_this.batchActionEl, 'transitionend', transition),
            )
          }
        },
      )
      ...
      _defineProperty(_assertThisInitialized(_this), '_toggleState', function (
        element,
        evt,
      ) {
      ...
      _defineProperty(
        ...
        function (evt) {
          ...
          var searchEvent = eventMatches(
            evt,
            _this.options.selectorSearchMagnifier,
          )
      ...
      _defineProperty(
        ...
        'refreshRows',
        function () {
          var newExpandCells = toArray$4(
            _this.element.querySelectorAll(_this.options.selectorExpandCells),
          )
          var newExpandableRows = toArray$4(
            _this.element.querySelectorAll(
              _this.options.selectorExpandableRows,
            ),
          )
          var newParentRows = toArray$4(
          ...
          if (_this.parentRows.length > 0) {
            ...
            if (newExpandableRows.length > 0) {
              ...
              var mergedExpandableRows = [].concat(
                _toConsumableArray(toArray$4(_this.expandableRows)),
                _toConsumableArray(toArray$4(diffExpandableRows)),
              )
      ...
      _this.manage(
        on(_this.element, 'click', function (evt) {
  ...
  var carbonFlatpickrMonthSelectPlugin = function carbonFlatpickrMonthSelectPlugin(
    config,
  ) {
    return function (fp) {
    ...
    function DatePicker(element, options) {
      ...
      _defineProperty(
        ...
        function (type) {
          ...
          var calendar = new flatpickr(
            ...
            Object.assign(flattenOptions(_this.options), {
              ...
              onChange: function onChange() {
                ...
                if (
                  !_onChange ||
                  _onChange.call.apply(_onChange, [this].concat(args)) !== false
                ) {
                  self._updateClassNames(calendar)
              ...
              onOpen: function onOpen() {
                ...
                if (
                  !_onOpen ||
                  _onOpen.call.apply(_onOpen, [this].concat(args)) !== false
                ) {
                  self._updateClassNames(calendar)
                }
              },
          ...
          _this.manage(
            on(
              _this.element.querySelector(_this.options.selectorDatePickerIcon),
              'click',
              function () {
                calendar.open()
              },
      ...
      _defineProperty(
        ...
        function (input, index) {
          ...
          _this.manage(
            on(inputField, 'change', function (evt) {
              if (
                evt.isTrusted ||
          ...
          _this.manage(
            on(inputField, 'keydown', function (evt) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_formatDate', function (
        date,
      ) {
      ...
      if (_this.calendar.calendarContainer) {
        _this.manage(
          on(_this.element, 'keydown', function (e) {
            if (e.which === 40) {
              e.preventDefault()
        ...
        _this.manage(
          on(_this.calendar.calendarContainer, 'keydown', function (e) {
            if (e.which === 9 && _type === 'range') {
              _this._updateClassNames(_this.calendar)

              _this.element
                .querySelector(_this.options.selectorDatePickerInputFrom)
                .focus()
            }
          }),
        )
  ...
  var Pagination = /*#__PURE__*/ (function (_mixin) {
    ...
    function Pagination(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_emitEvent', function (
        evtName,
        detail,
      ) {
      ...
      _this.manage(
        on(_this.element, 'input', function (evt) {
  ...
  var Search = /*#__PURE__*/ (function (_mixin) {
    ...
    function Search(element, options) {
      ...
      _this.manage(
        on(_this.element, 'click', function (evt) {
          var toggleItem = eventMatches(
            evt,
            _this.options.selectorIconContainer,
          )
    ...
    function Accordion(element, options) {
      ...
      _this.manage(
        on(_this.element, 'click', function (event) {
          ...
          if (
            item &&
            !eventMatches(event, _this.options.selectorAccordionContent)
          ) {
            _this._toggle(item)
          }
        }),
      ...
      if (!_this._checkIfButton()) {
        _this.manage(
          on(_this.element, 'keypress', function (event) {
            var item = eventMatches(event, _this.options.selectorAccordionItem)
  ...
  var CopyButton = /*#__PURE__*/ (function (_mixin) {
    ...
    function CopyButton(element, options) {
      ...
      _this.manage(
        on(_this.element, 'click', function () {
          return _this.handleClick()
        }),
      )

      _this.manage(
        on(_this.element, 'animationend', function (event) {
  ...
  var Notification = /*#__PURE__*/ (function (_mixin) {
    ...
    function Notification(element, options) {
      ...
      if (_this.button) {
        _this.manage(
          on(_this.button, 'click', function (evt) {
  ...
  var Toolbar = /*#__PURE__*/ (function (_mixin) {
    ...
    function Toolbar(element, options) {
      ...
      if (!_this.element.dataset.tableTarget) {
        ...
        if (rowHeightBtns) {
          _this.manage(
            on(rowHeightBtns, 'click', function (event) {
      ...
      _this.manage(
        on(_this.element.ownerDocument, 'keydown', function (evt) {
          _this._handleKeyDown(evt)
        }),
      )

      _this.manage(
        on(_this.element.ownerDocument, 'click', function (evt) {
          _this._handleDocumentClick(evt)
        }),
      )
      ...
      [
        {
          ...
          value: function _handleDocumentClick(event) {
            ...
            var targetComponentElement = eventMatches(
              event,
        ...
        },
        {
          ...
          value: function _handleRowHeightChange(event, boundTable) {
            var _event$currentTarget$ = event.currentTarget.querySelector(
                'input:checked',
              ),
  ...
  var getMenuOffset$1 = function getMenuOffset(menuBody, menuDirection) {
    ...
    _defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_LEFT, 'right'),
    _defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_TOP, 'bottom'),
    _defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_RIGHT, 'left'),
    _defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_BOTTOM, 'top'),
    _DIRECTION_LEFT$DIREC)[menuDirection]
    var menuPositionAdjustmentProp = ((_DIRECTION_LEFT$DIREC2 = {}),
    _defineProperty(_DIRECTION_LEFT$DIREC2, DIRECTION_LEFT, 'left'),
    _defineProperty(_DIRECTION_LEFT$DIREC2, DIRECTION_TOP, 'top'),
    _defineProperty(_DIRECTION_LEFT$DIREC2, DIRECTION_RIGHT, 'left'),
    _defineProperty(_DIRECTION_LEFT$DIREC2, DIRECTION_BOTTOM, 'top'),
    _DIRECTION_LEFT$DIREC2)[menuDirection]
    var values = [arrowPositionProp, 'border-bottom-width'].reduce(function (
      o,
      name,
    ) {
  ...
  var TooltipSimple = /*#__PURE__*/ (function (_mixin) {
    ...
    function TooltipSimple(element, options) {
      ...
      _defineProperty(
        ...
        function () {
          return _this.element.matches(_this.options.selectorTriggerButton)
            ? _this.element
            : _this.element.querySelector(_this.options.selectorTriggerButton)
        },
      )

      _defineProperty(
        _assertThisInitialized(_this),
        'allowTooltipVisibility',
        function (_ref) {
      ...
      _this.manage(
        on(_this.element, 'mouseenter', function () {
      ...
      _this.manage(
        on(_this.element, 'focusin', function (event) {
  ...
  var ProgressIndicator = /*#__PURE__*/ (function (_mixin) {
    ...
    function ProgressIndicator(element, options) {
      // Use return false to stop error index 
      //return false;
  ...
  var StructuredList = /*#__PURE__*/ (function (_mixin) {
    ...
    function StructuredList(element, options) {
      ...
      _this.manage(
        on(_this.element, 'keydown', function (evt) {
          if (
            evt.which === 37 ||
            evt.which === 38 ||
            evt.which === 39 ||
  ...
  var Slider = /*#__PURE__*/ (function (_mixin) {
    ...
    function Slider(element, options) {
      ...
      if (_this.element.dataset.sliderInputBox) {
        ...
        _this.manage(
          on(_this.boundInput, 'change', function (evt) {
            _this.setValue(evt.target.value)
          }),
        )

        _this.manage(
          on(_this.boundInput, 'focus', function (evt) {
            evt.target.select()
          }),
        ) // workaround for safari

        _this.manage(
          on(_this.boundInput, 'mouseup', function (evt) {
            evt.preventDefault()
          }),
        )
      }
      ...
      _this.manage(
        on(_this.thumb, 'mousedown', function () {
          _this.sliderActive = true
        }),
      )

      _this.manage(
        on(_this.element.ownerDocument, 'mouseup', function () {
          _this.sliderActive = false
        }),
      )

      _this.manage(
        on(_this.element.ownerDocument, 'mousemove', function (evt) {
      ...
      _this.manage(
        on(_this.thumb, 'keydown', function (evt) {
          var disabled = _this.element.classList.contains(
            _this.options.classDisabled,
          )
      ...
      _this.manage(
        on(_this.track, 'click', function (evt) {
          var disabled = _this.element.classList.contains(
            _this.options.classDisabled,
          )
      ...
      [
        {
          ...
          value: function _updatePosition(evt) {
            ...
            requestAnimationFrame(function () {
              ...
              _this2.filledTrack.style.transform = 'translate(0%, -50%) scaleX('.concat(
                left / 100,
                ')',
              )
  ...
  var Tile = /*#__PURE__*/ (function (_mixin) {
    ...
    function Tile(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_getClass', function (
        type,
      ) {
        var typeObj = {
      ...
      _defineProperty(_assertThisInitialized(_this), '_hookActions', function (
        tileClass,
      ) {
        ...
        if (isExpandable) {
          ...
          var getStyle = _this.element.ownerDocument.defaultView.getComputedStyle(
            _this.element,
            null,
          )
          ...
          if (
            _this.element.classList.contains(_this.options.classExpandedTile)
          ) {
  ...
  var TextInput = /*#__PURE__*/ (function (_mixin) {
    ...
    function TextInput(_element, options) {
      ...
      _this.manage(
        on(_this.element, 'click', function (event) {
          var toggleVisibilityButton = eventMatches(
            event,
            _this.options.selectorPasswordVisibilityButton,
          )
    ...
    _createClass(TextInput, null, [
      {
        ...
        get: function get() {
          ...
          return {
            ...
            selectorPasswordVisibilityTooltip: '.'
              .concat(prefix, '--text-input--password__visibility__toggle > .')
  ...
  var SideNav = /*#__PURE__*/ (function (_mixin) {
    ...
    function SideNav(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_handleClick', function (
        ...
        var matchesToggle = eventMatches(
          evt,
          _this.options.selectorSideNavToggle,
        )
        var matchesNavSubmenu = eventMatches(
          evt,
          _this.options.selectorSideNavSubmenu,
        )
        var matchesSideNavLink = eventMatches(
          evt,
          _this.options.selectorSideNavLink,
        )
  ...
  var HeaderSubmenu = /*#__PURE__*/ (function (_mixin) {
    ...
    function HeaderSubmenu(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_getAction', function (
        event,
      ) {
        ...
        switch (event.type) {
          ...
          case 'click':
            return eventMatches(event, _this.options.selectorItem)
      ...
      _defineProperty(_assertThisInitialized(_this), '_getNewState', function (
        action,
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this), '_handleEvent', function (
        event,
      ) {
        var trigger = _this.element.querySelector(_this.options.selectorTrigger)
              ...
              if (expanded) {
                ...
                switch (event.which) {
                  ...
                  case 36: {
                    ...
                    var _this$element$querySe = _this.element.querySelectorAll(
                        _this.options.selectorItem,
                      ),
  ...
  var HeaderNav = /*#__PURE__*/ (function (_mixin) {
    ...
    function HeaderNav(element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), 'navigate', function (
        ...
        var items = toArray$b(
          _this.element.querySelectorAll(_this.options.selectorSubmenuLink),
        )
    ...
    function NavigationMenu(element, options) {
      ...
      _defineProperty(
        ...
        function (event) {
          ...
          var matchesNavSubmenu = eventMatches(
            event,
            _this.options.selectorShellNavSubmenu,
          )
          var matchesShellNavLink = eventMatches(
            event,
      ...
      _defineProperty(_assertThisInitialized(_this), '_handleClick', function (
        ...
        var matchesNestedShellNavLink = eventMatches(
          event,
          _this.options.selectorShellNestedNavLink,
        )
    ...
    function ProductSwitcher(element, options) {
      ...
      _defineProperty(
        ...
        function (event) {
          ...
          var currentTriggerButton = _this.element.ownerDocument.getElementById(
            _this.current,
          )
          ...
          if (
            ...
            event.relatedTarget &&
            !event.relatedTarget.matches(_this.options.selectorFloatingMenus)
          ) {
  ...
  var PaginationNav = /*#__PURE__*/ (function (_mixin) {
    ...
    function PaginationNav(element, options) {
      ...
      _defineProperty(
        ...
        function (evt) {
          ...
          if (pageSelectElement) {
            ...
            Array.prototype.forEach.call(pageSelectElementOptions, function (
              el,
            ) {
              el.removeAttribute(_this.options.attribActive)
            })
      ...
      _this.manage(
        on(_this.element, 'change', function (evt) {
          if (evt.target.matches(_this.options.selectorPageSelect)) {
  ...
  var init = function init() {
    var componentClasses = Object.keys(components$1)
      .map(function (key) {
  ...
  var createAndReleaseComponentsUponDOMMutation = function createAndReleaseComponentsUponDOMMutation(
    records,
    componentClasses,
  ...
  function watch() {
    ...
    var componentClasses = Object.keys(components)
      .map(function (key) {
